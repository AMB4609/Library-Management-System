...
//                        .permitAll()
                        .requestMatchers("api/login/loginUser", "api/books/getBookById/{bookId}", "api/books/getAllBooks","api/reviewAndRating/addReviewAndRating","api/reviewAndRating/toggleLikeToReview","api/reviewAndRating/toggleDisLikeToReview","api/branch/getAllBranches","api/branch/getBranchById/{branchId}")
                        .permitAll()
